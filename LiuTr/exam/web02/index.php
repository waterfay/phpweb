...
<iframe name="back" style="display:none;"></iframe>
	<div id="all">
    	<div id="title">
		<?php
			$total=$Visit->q("select sum(`total`) from `visit`")[0][0];
			?>
        <?= date("m 月 d 日 l");?> | 今日瀏覽:<?=$visit['total']?>  | 累積瀏覽:<?=$total?> </div>
        <div id="title2">
        ...
        <div style="text-align:right;font-size:10px; align-items: center;">

    	    本網站建議使用：IE9.0以上版本，1024 x 768 pixels 以上觀賞瀏覽 ， Copyright © 2021健康促進網社群平台 All Right Reserved 
    		 <br>
    		 服務信箱：health@test.labor.gov.tw<img src="./icon/02B02.jpg" width="30" >	
		</div>
